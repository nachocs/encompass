 ...
 * @since 1.0.0
 */
Encompass.WorkspaceSubmissionController = Ember.Controller.extend(
  Encompass.CurrentUserMixin,
  {
    ...
    isMyWorkspace: function() {
      let ownerId = this.get("utils").getBelongsToId(
    ...
    canRespond: function() {
      return this.get("permissions").canEdit(
        this.get("currentWorkspace"),
        "feedback",
        1
      );
    ...
    containerLayoutClass: function() {
      let areFoldersHidden =
        this.get("areFoldersHidden") || this.get("cannotSeeFolders");
      let areCommentsHidden =
        this.get("areCommentsHidden") || this.get("cannotSeeComments");
    ...
    actions: {
      ...
      toggleHeaderDisplay() {
        this.toggleProperty("isHeaderHidden");
      }
    }
  }
);
