...
Encompass.WorkspaceSubmissionComponent = Ember.Component.extend(
  ...
  Encompass.VmtHostMixin,
  {
    ...
    showSelectableView: Ember.computed(
      "makingSelection",
      "showingSelections",
      "isTransitioning",
      function() {
    ...
    // vmtContainer: Ember.computed(''),

    areNoSelections: function() {
      return (
        this.get("canSeeSelections") &&
        !this.get("workspaceSelections.length") > 0
      );
    ...
    setOwnHeight() {
      ...
      this.$()
        .css("height", "100%")
        .css("height", `-=${revisionsNavHeight}px`);
    },
    ...
    isVmt: function() {
      return this.get("utils").isValidMongoId(
